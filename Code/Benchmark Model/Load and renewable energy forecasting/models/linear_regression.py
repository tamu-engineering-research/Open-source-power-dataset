...
def grid_search_linear_regression(config, num_files):
...
if __name__ == '__main__':
    ...
    with open('./../configs/linear_regression.yaml', 'r') as file:
        try:
    ...
    grid_search_linear_regression(config, num_files=args['num_files'])
